...
import p.android.support.v4.content.Loader;
import p.android.support.v4.media.session.MediaControllerCompat;
...
import p.android.support.v4.util.SimpleArrayMap;
import p.android.support.v4.util.SparseArrayCompat;
...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements
     ...
     * active {@link MediaSessionCompat} and media button receiver
