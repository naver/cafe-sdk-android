...
import p.android.support.v4.util.LongSparseArray;
import p.android.support.v4.util.Pools;

import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_PRE;
import static p.android.support.v7.widget.ViewInfoStore.InfoRecord.FLAG_POST;
/**
