...
import p.com.bumptech.glide.load.resource.bitmap.BitmapTransformation;
import p.com.bumptech.glide.load.resource.bitmap.Downsampler;
import p.com.bumptech.glide.load.resource.bitmap.CenterCrop;
import p.com.bumptech.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import p.com.bumptech.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import p.com.bumptech.glide.load.resource.bitmap.FitCenter;
import p.com.bumptech.glide.load.resource.bitmap.StreamBitmapDecoder;
import p.com.bumptech.glide.load.resource.bitmap.VideoBitmapDecoder;
