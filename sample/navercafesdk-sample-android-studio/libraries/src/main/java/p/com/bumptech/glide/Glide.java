...
import p.com.bumptech.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import p.com.bumptech.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import p.com.bumptech.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import p.com.bumptech.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import p.com.bumptech.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import p.com.bumptech.glide.load.model.stream.HttpUrlGlideUrlLoader;
import p.com.bumptech.glide.load.model.stream.StreamByteArrayLoader;
import p.com.bumptech.glide.load.model.stream.StreamFileLoader;
import p.com.bumptech.glide.load.model.stream.StreamModelLoader;
import p.com.bumptech.glide.load.model.stream.StreamResourceLoader;
import p.com.bumptech.glide.load.model.stream.StreamStringLoader;
import p.com.bumptech.glide.load.model.stream.StreamUriLoader;
import p.com.bumptech.glide.load.model.stream.StreamUrlLoader;
import p.android.support.v4.app.Fragment;
import p.android.support.v4.app.FragmentActivity;
import android.util.Log;
import android.view.View;
import android.widget.ImageView;

import p.com.bumptech.glide.load.DecodeFormat;
import p.com.bumptech.glide.load.ResourceDecoder;
import p.com.bumptech.glide.load.Transformation;
import p.com.bumptech.glide.load.engine.Engine;
import p.com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool;
import p.com.bumptech.glide.load.engine.cache.DiskCache;
import p.com.bumptech.glide.load.engine.cache.DiskLruCacheFactory;
import p.com.bumptech.glide.load.engine.cache.MemoryCache;
import p.com.bumptech.glide.load.engine.prefill.BitmapPreFiller;
import p.com.bumptech.glide.load.engine.prefill.PreFillType;
import p.com.bumptech.glide.load.resource.bitmap.CenterCrop;
import p.com.bumptech.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import p.com.bumptech.glide.load.resource.bitmap.FitCenter;
import p.com.bumptech.glide.load.resource.bitmap.GlideBitmapDrawable;
import p.com.bumptech.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import p.com.bumptech.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import p.com.bumptech.glide.load.resource.drawable.GlideDrawable;
import p.com.bumptech.glide.load.resource.file.StreamFileDataLoadProvider;
import p.com.bumptech.glide.load.resource.gif.GifDrawable;
import p.com.bumptech.glide.load.resource.gif.GifDrawableLoadProvider;
import p.com.bumptech.glide.load.resource.gifbitmap.GifBitmapWrapper;
import p.com.bumptech.glide.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import p.com.bumptech.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import p.com.bumptech.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import p.com.bumptech.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import p.com.bumptech.glide.load.resource.transcode.ResourceTranscoder;
import p.com.bumptech.glide.load.resource.transcode.TranscoderRegistry;
import p.com.bumptech.glide.manager.RequestManagerRetriever;
import p.com.bumptech.glide.module.GlideModule;
import p.com.bumptech.glide.module.ManifestParser;
import p.com.bumptech.glide.provider.DataLoadProvider;
import p.com.bumptech.glide.provider.DataLoadProviderRegistry;
import p.com.bumptech.glide.request.FutureTarget;
import p.com.bumptech.glide.request.Request;
import p.com.bumptech.glide.request.animation.GlideAnimation;
import p.com.bumptech.glide.request.target.ImageViewTargetFactory;
import p.com.bumptech.glide.request.target.Target;
import p.com.bumptech.glide.request.target.ViewTarget;
