...
import p.com.bumptech.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import p.com.bumptech.glide.load.engine.bitmap_recycle.LruBitmapPool;
import p.com.bumptech.glide.load.engine.cache.DiskCache;
import p.com.bumptech.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import p.com.bumptech.glide.load.engine.cache.LruResourceCache;
import p.com.bumptech.glide.load.engine.cache.MemoryCache;
import p.com.bumptech.glide.load.engine.cache.MemorySizeCalculator;
import p.com.bumptech.glide.load.engine.executor.FifoPriorityThreadPoolExecutor;
