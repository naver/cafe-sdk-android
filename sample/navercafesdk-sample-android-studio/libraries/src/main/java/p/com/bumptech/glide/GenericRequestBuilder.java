...
import p.com.bumptech.glide.load.MultiTransformation;
...
import p.com.bumptech.glide.load.engine.DiskCacheStrategy;
import p.com.bumptech.glide.load.resource.UnitTransformation;
...
import p.com.bumptech.glide.manager.Lifecycle;
import p.com.bumptech.glide.manager.RequestTracker;
import p.com.bumptech.glide.provider.ChildLoadProvider;
import p.com.bumptech.glide.provider.LoadProvider;
import p.com.bumptech.glide.request.FutureTarget;
import p.com.bumptech.glide.request.GenericRequest;
import p.com.bumptech.glide.request.Request;
import p.com.bumptech.glide.request.RequestCoordinator;
import p.com.bumptech.glide.request.RequestFutureTarget;
import p.com.bumptech.glide.request.RequestListener;
import p.com.bumptech.glide.request.ThumbnailRequestCoordinator;
import p.com.bumptech.glide.request.animation.GlideAnimationFactory;
import p.com.bumptech.glide.request.animation.NoAnimation;
import p.com.bumptech.glide.request.animation.ViewAnimationFactory;
import p.com.bumptech.glide.request.animation.ViewPropertyAnimation;
import p.com.bumptech.glide.request.animation.ViewPropertyAnimationFactory;
import p.com.bumptech.glide.request.target.PreloadTarget;
import p.com.bumptech.glide.request.target.Target;
import p.com.bumptech.glide.signature.EmptySignature;
import p.com.bumptech.glide.util.Util;
import p.com.bumptech.glide.load.model.ModelLoader;
import p.com.bumptech.glide.load.resource.transcode.UnitTranscoder;
import p.com.bumptech.glide.request.target.SizeReadyCallback;
import p.com.bumptech.glide.signature.StringSignature;
